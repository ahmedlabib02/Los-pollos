...
class NotificationService {
  ...
  Future<void> sendOffersNotification({
    ...
    try {
      ...
      if (result.data['success']) {
        print("Offers notification sent successfully");
      } else {
        print("Failed to send offers notification: ${result.data['message']}");
      }
    } catch (e) {
      print("Error calling sendDiscountNotification Cloud Function: $e");
    }
  }
}
